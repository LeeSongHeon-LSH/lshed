...
> **배포**: GitHub `LeeSongHeon-LSH/lshed`(public), npm `lshed`(latest 0.16.1; 0.17.0 은 태그 후 사용자가 발행; 0.15.2 는 npm 미발행), 릴리스마다 실행파일 5종 + SHA256SUMS (v0.17.0 까지 release 워크플로가 게시)
...
- [x] npm 발행 — 0.4.0 은 2026-09-03, 이후 0.6.0·0.7.0·0.7.2·0.7.4·0.8.0·0.10.0·0.12.0·0.13.0·0.14.0·0.14.1·0.14.2·0.15.0·0.15.1·0.15.3·0.15.4·0.15.5·0.16.0·0.16.1 (0.15.2 와 0.1.1~0.3.0 중 0.2.1·0.3.0 발행, 나머지는 건너뜀; 0.17.0 은 발행 대기); GitHub 릴리스는 v0.17.0 까지 실행파일 5종 게시
